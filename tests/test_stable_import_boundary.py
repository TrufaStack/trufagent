...
def test_importing_stable_cli_does_not_load_delegation_runtime() -> None:
    modules = [
        ...
        "trufagent.experimental.cli",
        "trufagent.experimental.codex_skill_surface",
        ...
        "trufagent.experimental.pilot_fs",
        "trufagent.experimental.promotion",
        "trufagent.experimental.promotion_fs",
        "trufagent.experimental.promotion_review",
        "trufagent.experimental.promotion_workspace",
